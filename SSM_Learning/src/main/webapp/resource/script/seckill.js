    ...
    URl: {
        now:function () {
        	// return '/seckill/seckill/time/now';
        	 return '/SSM_Learning/seckill/time/now';
        },
        exposer:function(seckillId){
        	//return '/seckill/seckill/'+seckillId+'/exposer';
        	return '/SSM_Learning/seckill/'+seckillId+'/exposer';
            
        },
        execution:function(md5,seckillId){
            //return '/seckill/seckill/'+seckillId+'/'+md5+'/execution';
        	return '/SSM_Learning/seckill/'+seckillId+'/'+md5+'/execution';
        }
            ...
            if (!seckill.validatePhone(killPhone)) {
                ...
                $('#killPhoneBtn').click(function () {
                    ...
                    if (seckill.validatePhone(inputPhone)) {
                        //电话写入cookie(7天过期)
                        $.cookie('killPhone', inputPhone, {expries: 7, path: '/SSM_Learning/seckill'})
                        //验证通过　　刷新页面
